"""OSRS metric to wiki icon URL mapping, ported from web-app wikiIcons.ts."""

from __future__ import annotations

_WIKI = "https://oldschool.runescape.wiki/images"

_BOSS_ICON: dict[str, str] = {
...
def metric_icon_url(metric: str) -> str:
    """Return the wiki icon URL for a WOM metric slug, or empty string."""
    file = _SKILL_ICON.get(metric) or _BOSS_ICON.get(metric)
    return f"{_WIKI}/{file}" if file else ""
