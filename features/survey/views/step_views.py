...
from features.survey.models import SurveyField

if TYPE_CHECKING:
    pass


class SurveyLike(Protocol):
    """Structural interface satisfied by both SurveyService and ApplicationService."""
...
class SkipButton(discord.ui.Button):  # type: ignore[type-arg]
    def __init__(self, service: SurveyLike, ticket_id: int, field_id: str) -> None:
