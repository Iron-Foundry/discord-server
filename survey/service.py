...
class SurveyService(Service):
    ...
    def set_ticket_service(self, ticket_service: "TicketService", staff_role_id: int) -> None:
        ...
        if self._current_template:
            ...
            logger.info("Survey: re-enabling ticket type (active template found on startup)")
        else:
    ...
    async def delete_responses(self, template_id: str) -> int:
        return await self._repo.delete_responses_for_template(self._guild.id, template_id)
    ...
    async def start_survey(
        ...
        *,
        ...
        await self._repo.update_response(
            ticket_id, summary_message_id=summary_msg.id
        )
