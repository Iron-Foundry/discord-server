...
from survey.models import SurveyField, SurveyResponse, SurveyTemplate
...
def _staff_template(guild_id: int) -> SurveyTemplate:
    return SurveyTemplate(
        ...
        fields=[
            ...
            SurveyField(
                ...
                label="Region",
                description=(
                    "e.g. North America, Europe, Oceania, Asia, "
            ...
            SurveyField(
                ...
                description=(
                    "Tell us about any staff or moderation experience you have."
                ),
                required=True,
            ),
            SurveyField(
                ...
                description="Tell us about your motivation to join the team.",
                required=True,
            ),
        ],
...
def _mentor_template(guild_id: int) -> SurveyTemplate:
    return SurveyTemplate(
...
class ApplicationService:
    ...
    def __init__(self, guild: discord.Guild, repo: MongoSurveyRepository) -> None:
        ...
        self._templates: dict[str, SurveyTemplate] = {
            TicketTypeId.APPLY_STAFF.value: _staff_template(guild.id),
            TicketTypeId.APPLY_MENTOR.value: _mentor_template(guild.id),
        }
    ...
    def register_ticket_types(
        ...
        """
        from tickets.types.apply_mentor import ApplyMentorTicket
        from tickets.types.apply_staff import ApplyStaffTicket
    ...
    async def _post_summary_message(
        ...
        from applications.views import ApplicationResetView
    ...
    async def _post_completion(
        ...
        from applications.views import ApplicationCompleteView
